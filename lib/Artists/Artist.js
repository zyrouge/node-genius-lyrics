...
class Artist {
     ...
     */
    constructor(res, key, partial = false) {
    ...
    songs(options = {}) {
        ...
        return new Promise((resolve, reject) => {
            ...
            .then(res => {
                ...
                const tracks = res.data.response.songs.map(s => new Song(s, this.key, true));
                resolve(tracks);
            })
            .catch(e => {
    ...
    fetch() {
        ...
        return new Promise((resolve, reject) => {
            ...
            .then(res => {
                ...
                const artist = new Artist(res.data.response.artist, this.key, false);
                resolve(artist);
            })
            .catch(e => {
                if(e && e.response && e.response.status && e.response.status == 401) reject(CONSTANTS.INV_TOKEN);
