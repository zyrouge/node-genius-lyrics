...
class Artist {
     ...
     */
    constructor(res, key, partial = false, config = { requestOptions: {baseURL: CONSTANTS.BASE_URL} }) {
    ...
    songs(options = {}) {
        ...
        return new Promise((resolve, reject) => {
            axios.get(`/artists/${this.id}/songs?page=${page}&per_page=${per_page}&sort=${sort}`, {
